# This is the source for a module in the cryptography package's openssl bindings.
# I have slightly modified it to not sign outgoing data,
# so that we can use very small RSA keys.
patched_file = r"""
...
if __name__ == "__main__":
    ...
    # The __file__ attribute gives the filepath of a python module.
